        ...
        children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // ✅ Documents Section
                      if (lawyer.documents != null && lawyer.documents!.isNotEmpty) ...[
                        const SizedBox(height: 32),
                        _buildSectionTitle('documents_section'.tr()),
                        const SizedBox(height: 16),
                        ...lawyer.documents!.map((doc) {
                          final isImage = ['jpg', 'png', 'jpeg'].contains(doc['type']?.toString().toLowerCase());
                                ...
                                builder: (ctx) => Dialog(
                                  ...
                                  child: Stack(
                                    children: [
                                      ClipRRect(
                                        borderRadius: BorderRadius.circular(16),
                                        child: Image.memory(base64Decode(doc['base64'])),
                                      ),
                                      Positioned(
                                        right: 10,
                                        top: 10,
          ...
          Positioned(
            ...
            child: IconButton(
              ...
              tooltip: 'report'.tr(),
              onPressed: () => SignalementService.showReportDialog(
                context: context,
                reportedUserId: lawyer.uid,
                reportedUserName: lawyer.name,
                reportedUserRole: 'lawyer',
              ),
            ),
          ),
        ],
