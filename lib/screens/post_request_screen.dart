...
class _PostRequestScreenState extends State<PostRequestScreen>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final safetyResult = await GeminiService.validateContentSafety(fullText);
        ...
        child: DropdownButton<String>(
          ...
          hint: Row(
            children: [
              ...
              Text('select_category_hint'.tr(), style: const TextStyle(color: greyText, fontSize: 14)),
            ],
          ),
            ...
            return DropdownMenuItem<String>(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Text(cat.tr(), style: const TextStyle(color: darkText, fontSize: 14, fontWeight: FontWeight.w600)),
                ],
              ),
            );
          }).toList(),
