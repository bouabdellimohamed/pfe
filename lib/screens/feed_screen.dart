...
class _LegalDomainsList {
  static const domains = [
    ...
    _Domain('Droit des sociétés', Icons.business_rounded, Color(0xFF0052D4)),
    _Domain('Droit fiscal', Icons.request_quote_rounded, Color(0xFF7C3AED)),
    _Domain('Propriété Intellectuelle', Icons.lightbulb_rounded, Color(0xFF7C3AED)),
    _Domain('Droit bancaire', Icons.account_balance_rounded, Color(0xFF1D4ED8)),
    _Domain('Droit des assurances', Icons.shield_rounded, Color(0xFF0891B2)),
    _Domain('Droit médical', Icons.local_hospital_rounded, Color(0xFFDC2626)),
    _Domain('Droit social', Icons.people_rounded, Color(0xFF7E22CE)),
    _Domain('Droit de la consommation', Icons.shopping_cart_rounded, Color(0xFF15803D)),
  ];
}
